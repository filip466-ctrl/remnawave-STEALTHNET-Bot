...
const replacement = `return (
    <div className="relative w-full rounded-[2.5rem] border-2 border-primary/30 dark:border-primary/40 bg-white/50 dark:bg-black/20 backdrop-blur-xl shadow-[inset_0_0_60px_rgba(0,0,0,0.1),0_8px_32px_hsl(var(--primary)/0.1)] overflow-hidden">
